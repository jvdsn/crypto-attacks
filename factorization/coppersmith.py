...
def factorize_univariate(n, bitsize, msb_known, msb, lsb_known, lsb):
    """
...
def factorize_bivariate(n, p_bitsize, p_msb_known, p_msb, p_lsb_known, p_lsb, q_bitsize, q_msb_known, q_msb, q_lsb_known, q_lsb):
    """
    Recovers the prime factors from a modulus using Coppersmith's method.
